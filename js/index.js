...
function renderTasks(){
    ...
    for (let task of tasks){
        ...
        newItem.setAttribute('class', 'list-group-item list-group-item-dark d-flex justify-content-between')
        newItem.appendChild(document.createTextNode(task.date + "    -    " + task.title))
...
async function addTask(){
    ...
    var date = document.getElementById('newItemData').value
